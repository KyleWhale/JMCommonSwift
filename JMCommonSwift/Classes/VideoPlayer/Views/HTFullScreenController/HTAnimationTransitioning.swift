//
//  HTAnimationTransitioning.swift
//  Cartoon
//
...
extension HTAnimationTransitioning {
    enum HTAnimationType {
        case present
        case dismiss
    }

    enum HTAnimationOrientation {
        case left
        case right
        case fullRight
    }
...
class HTAnimationTransitioning: NSObject {
    ...
    private weak var player: HTPlayer?
    ...
    private var orientation: HTAnimationOrientation = .left

    var animationType: HTAnimationType = .present

    init(playView: HTPlayer, orientation: HTAnimationOrientation) {
        player = playView
...
extension HTAnimationTransitioning: UIViewControllerAnimatedTransitioning {
