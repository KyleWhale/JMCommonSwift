...
extension NSMutableAttributedString {
    // =========================字体的设置=========================//
    /// 设置字体大小
    public func yn_addFont(_ font: UIFont, on range: NSRange) {
    ...
    /// 设置字体颜色
    public func yn_addForegroundColor(_ color: UIColor, range: NSRange) {
    ...
    /// 设置字体的背景颜色
    public func yn_addBackgroundColor(_ color: UIColor, range: NSRange) {
...
extension NSMutableAttributedString {
    ...
    public func yn_addKern(_ kern: Int, range: NSRange) {
    ...
    /// 设置字体倾斜度，正值右倾，负值左倾
    public func yn_addObliqueness(_ obliqueness: CGFloat, range: NSRange) {
    ...
    /// 设置字体的横向拉伸，正值拉伸 ，负值压缩
    public func yn_addExpansion(_ expansion: CGFloat, range: NSRange) {
    ...
    /// 文字书写方向
    public func yn_addWritingDirection(_ direction: NSWritingDirection, range: NSRange) {
...
extension NSMutableAttributedString {
    ...
    public func yn_addStrikethrough(style: NSUnderlineStyle = .single, color: UIColor? = nil, range: NSRange) {
    ...
    public func yn_addUnderLine(style: NSUnderlineStyle = .single, color: UIColor? = nil, range: NSRange) {
...
extension NSMutableAttributedString {
    //=========================文字的效果==========================//
    /// 设置文字的描边
    public func yn_addStroke(color: UIColor, width: CGFloat, range: NSRange) {
    ...
    /// 阴影
    public func yn_addShadow(_ shadow: NSShadow, range: NSRange) {
        if self.length < range.location + range.length { return }
    ...
    public func yn_addTextEffect(effect: NSAttributedString.TextEffectStyle = .letterpressStyle, range: NSRange) {
        if self.length < range.location + range.length { return }
...
extension NSMutableAttributedString {
    ...
    //=========================偏移量==========================//
    /// 设置上下偏移量 正数上移，负数下移
    public func yn_addBaselineOffset(_ offset: CGFloat, range: NSRange) {
        if self.length < range.location + range.length { return }
    ...
    /// 设置行间距
    public func yn_addLineSpacing(_ style: NSMutableParagraphStyle, range: NSRange) {
...
extension NSMutableAttributedString {
    ...
    /// 插入图片
    public func yn_addTextAttachment(image: UIImage?, imageFrame: CGRect, atIndex index: Int) {
